...
class Climber():
    def __init__(self):
         self.climber_right_motor = rev.SparkMax(5, rev.SparkLowLevel.MotorType.kBrushed)
         self.climber_left_motor = rev.SparkMax(6, rev.SparkLowLevel.MotorType.kBrushed)
